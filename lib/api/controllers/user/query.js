...
var query = module.exports.query = function query(query, req, res, rFields, next){
  MongooseStudentModel.find(query, function(err, docs){
...
var queryJoin = module.exports.queryJoin = function queryJoin(queries, skip, limit, fields, req, res, next){
  ...
  async.map(queries, function(sQuery, callback){
    query(sQuery, req, res, rFields, callback);
  }, function(err, res){
