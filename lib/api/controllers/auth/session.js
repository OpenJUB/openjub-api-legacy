...
exports.createSession = function(req, user, callback){
  ...
  entry.save(function(err, entry){
    ...
    var token = jwt.sign({'id': entry.id, 'createdAt': entry.createdAt.toString()}, settings.token.secret);
...
exports.decodeSession = function(req, callback){
  ...
  jwt.verify(token, settings.token.secret, function(err, data){
    ...
    models.Session.findById(id, function (err, entry) {
      ...
      if(entry.createdAt.toString() !== data.createdAt){
        callback(false);
        return;
      }
...
exports.deleteSession = function(req, callback){
  ...
  jwt.verify(token, settings.token.secret, function(err, id){
    ...
    models.Session.findByIdAndRemove(id, function (err, entry) {
