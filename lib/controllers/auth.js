...
exports.checkCampusIp = function(ip) {
  return (ip.indexOf('10.') === 0 || ip.indexOf('::ffff:10.') === 0 || ip === '::1' || ip === '::ffff:127.0.0.1' || ip === '127.0.0.1');
};

exports.checkCampus = function (req, res) {
  var ip = req.ip;

  res.json({'on_campus': exports.checkCampusIp(ip)});
};
