...
module.exports.route = function (app) {
  /**
   * @api {get} /login/isoncampus Check on-campus status
   * @apiVersion 0.1.0
   ...
   *    }
   */
  app.get('/login/isoncampus', Controllers.Auth.checkCampus);

  /**
   * @api {post} /login/signin Login as a specific user
   * @apiVersion 0.1.0
   ...
   *    }
   */
  app.post('/login/signin', Controllers.Auth.login);

  /**
   * @api {post} /login/status Get the current authentication status.
   * @apiVersion 0.1.0
   * @apiName Login as a campusnet user.
   * @apiGroup Authentication
   *
   ...
   *    }
   */
  app.get('/login/status', Controllers.Auth.need, Controllers.Auth.status);
  return;
